    ...
    <div class="boxv">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"><a href="<?php echo Yii::app()->createUrl('/wx/movie/push',array('id'=>14,'stbid'=>$stbid))?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/wx/image/sd.jpg"></a></div>
                <div class="swiper-slide"><a href="<?php echo Yii::app()->createUrl('/wx/movie/push',array('id'=>15,'stbid'=>$stbid))?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/wx/image/ny.jpg"></a></div>
            </div>
            <!-- Add Pagination -->
...
<div id="hidden" style="position: absolute;z-index:9999;top: 0;">
...
//        var id = $('input[name=id]').val();
        ...
        $.post('/wx/movie/getStbs',{stbid:stbid,name:name} ,function(d){
            if(d.code==404){
                sAlert(d.msg);
                $('.bdz').css('display','none');
                $('.submit').attr("disabled", false);
                ...
                $.post("/wx/movie/bd",{stbid:stbid,name:name,openid:openid},function(data){
                    sAlert('绑定成功');
                    location.reload();
                })
            }
