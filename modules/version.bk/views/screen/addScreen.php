...
<div>
    ...
    <img src="http://117.131.17.46:8087/file/template/t01.png" alt="" width='600px' height='300px'>
</div>
</div>
</td></tr>
<tr>
...
<script>
    ...
    function showTemplate(obj)
    {
        ...
        {
            case '1' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t01.png');
                break;
            case '2' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t02.png');
                break;
            case '3' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t03.png');
                break;
            case '4' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t04.png');
                break;
            case '5' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t05.png');
                break;
            case '6' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t06.png');
                break;
            case '7' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t07.png');
                break;
            case '8' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t08.png');
                break;
            case '9' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t09.png');
                break;
            case '10' :
                $('.templatePic').children('img').attr('src','http://117.131.17.46:8087/file/template/t10.jpg');
                break;
