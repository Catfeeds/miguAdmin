...
<table style="width:900px;" class="mtable mt10" cellpadding="10" cellspacing="0">
    ...
    <tr class="utp" style="display:none">
        ...
        <td colspan="3"><select name="uType" class="form-input w300" id="uType">
                <option  value="0" <?php if($screenContent[0]['uType']==0){echo 'selected';}?>>请选择</option>
                <option  value="1" <?php if($screenContent[0]['uType']==1){echo 'selected';}?>>搜索</option>
                <option  value="2" <?php if($screenContent[0]['uType']==2){echo 'selected';}?>>栏目</option>
                <!--<option  value="3" <?php //if($screenContent[0]['uType']==3){echo 'selected';}?>>详情</option>-->
                <option  value="4" <?php if($screenContent[0]['uType']==4){echo 'selected';}?>>专题</option>
                ...
                <option  value="7" <?php if($screenContent[0]['uType']==7){echo 'selected';}?>>电影详情页</option>
                <option  value="8" <?php if($screenContent[0]['uType']==8){echo 'selected';}?>>电视剧详情页</option>
                <option  value="9" <?php if($screenContent[0]['uType']==9){echo 'selected';}?>>单片横图模板</option>
                <option  value="10" <?php if($screenContent[0]['uType']==10){echo 'selected';}?>>综艺详情页</option>
                <option  value="14" <?php if($screenContent[0]['uType']==14){echo 'selected';}?>>无模板详情页</option>
                <option  value="15" <?php if($screenContent[0]['uType']==15){echo 'selected';}?>>文字列表页</option>
                ...
                <option  value="13" <?php if($screenContent[0]['uType']==13){echo 'selected';}?>>排行榜</option>
            </select>
        </td>
    </tr>
        ...
        <td colspan="3">
            <div  id="main">
                ...
                if($screenContent[0]['height'] == 1){
                    echo "<div class='m-".$screenContent[0]['width']."' >
                                <input type='file' id='upload_file_new'>";
                       if($screenContent[0]['height'] == 1){
                    echo "<img src=".$screenContent[0]['pic']." class='m-".$screenContent[0]['width']." oldPic' >";
                }else{
                    echo "<img src=".$screenContent[0]['pic']." class='m-".$screenContent[0]['width']."-".$screenContent[0]['height']." oldPic' >";
                }         
                              echo "</div>";
...
//        console.log(G);return false;
    ...
    $('.del').click(function()
    {
        ...
        $.get('/version/screen/firstPageDel?mid=<?php echo $this->mid?>&flag=1&id='+id,function(d){
            if(d.code == 200){
                //location.reload();
                alert('删除成功');
                window.close();
