...
<script>
    ...
    $('.search').click(function(){
        ...
        window.location.href="/version/station/index?mid="+mid+"&name="+name+"&cp="+cp+"&nid="+nid+'&adminLeftNavFlag=1&adminLeftOne='+adminLeftOne+'&adminLeftTwo='+adminLeftTwo+'&adminLeftOneName='+adminLeftOneName+'&adminLeftTwoName='+adminLeftTwoName;
    })
</script>
