...
<div >
    <div class="inputDiv">
        ...
        <input type="text" name="title"  style='width:70px;' class="form-input w100" value="<?php echo !empty($_GET['title'])?$_GET['title']:''?>" placeholder="请输入标题">
<span style="font-size:14px;">&nbsp;&nbsp;&nbsp;CP</span>
        <select name="cp" class="form-input w100" id="cp" style='width:70px;'>
	...
	<span style="float:left;font-size:14px;">&nbsp;&nbsp;&nbsp;类型</span>
        ...
        <select name="type" id="type" class="form-input w100" style='width:70px;'>
            <option value="0">请选择</option>
...
<span  style="font-size:14px;">&nbsp;&nbsp;</span>
        <input placeholder="结束时间" style="width:60px;height:18px;" type="text" name="timeend" id="timeend" class="form-input w100" value="<?php echo !empty($_GET['timeend'])?$_GET['timeend']:''?>">
