...
<table style="width:900px;" class="mtable mt10" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td><input type="text" name="user" id="user" class="form-input w300" value="<?php echo !empty($user->username)?$user->username:''?>"></td>
            <td align="right">昵称：</td>
            <td><input type="text" name="nick" id="nick" class="form-input w300" value="<?php echo !empty($user->nickname)?$user->nickname:''?>"></td>
        </tr>
        <tr>
            <td align="right">密码：</td>
            <td><input type="password" name="pass" id="pass" value="" class="form-input w300"></td>
            <td align="right">重复密码：</td>
            <td><input type="password" name="rePass" id="rePass" value="" class="form-input w300"></td>
        </tr>
        <tr>
            <td align="right">电子邮件：</td>
            <td><input type="text" name="email" id="email" class="form-input w300" value="<?php echo !empty($user->email)?$user->email:''?>"></td>
            <td align="right">联系电话：</td>
            <td><input type="text" name="tel" id="tel" class="form-input w300" value="<?php echo !empty($user->tel)?$user->tel:''?>"></td>
        </tr>
        <tr id="addr">
            ...
            <td>
                <input type="text" class="form-input w300" name="company" value="<?php echo !empty($user->company)?$user->company:''?>">
            </td>
        </tr>
        <tr>
            <th>用户权限信息</th>
