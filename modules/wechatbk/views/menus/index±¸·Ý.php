...
<!--                        <td>--><?php //echo $value['id']; ?><!--</td>-->
                        ...
                        <td <?php if(!empty($value['ChildrenList'])) echo " colspan='6' ";?>>
                            <table class="mid_con" style="margin-left: 0px; margin-top: -16px;">
                                <?php foreach($value['ChildrenList'] as $k=>$val){ ?>
                                    <tr class="mid_02" style="border-left:3px solid #f5da8c;">
                                        <!--                            <td>--><?php //echo $val['id'];  ?><!--</td>-->
<!--                                        <td></td>-->
<!--                                        <td>|--</td>-->
                                        <td style="width: auto"><?php echo $val['title'];  ?>&nbsp;</td>
                                        <td style="width: 110px;"><?php echo $val['description'];  ?>   </td>
                                        <td>
                                        ...
                                        <!--<td>{$val['btn_key']}</td>-->
                                        <td style="width: 110px;"><?php echo $val['MaterialTitle'];  ?></td>
                                        <td>
                        ...
                        <td<?php if(!empty($value['ChildrenList'])) echo " style='display:none'";?>><?php echo $value['description']; ?></td>
                        <td<?php if(!empty($value['ChildrenList'])) echo " style='display:none'";?>>
                        ...
                        <td<?php if(!empty($value['ChildrenList'])) echo " style='display:none'";?>><?php echo $value['url'];  ?></td>
                        <!--<td>{$value['btn_key']}</td>-->
                        <td<?php if(!empty($value['ChildrenList'])) echo " style='display:none'";?>><?php echo $value['MaterialTitle']; ?></td>
                        <td<?php if(!empty($value['ChildrenList'])) echo " style='display:none'";?>>
