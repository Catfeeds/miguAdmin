    ...
    <table id="tb" class="mtable mt10" cellpadding="10" cellspacing="0" width="100%">
        ...
        <?php
            if(!empty($list)){
                foreach($list as $k=>$v){?>
                    <tr>
                        <td><input type="checkbox" class="checkbox" name="id" value="<?php echo $v['cid']?>"></td>
                        ...
                        <input type="hidden" name="id" value="<?php echo $v['cid']?>">
                    </tr>
                <?php
                }
            }else{?>
...
<div class="over" style="display:none;position: absolute;left:400px;top:200px;background-color: gray;width:400px;height:300px" >
...
<script>
    $('.access').click(function(){
        ...
        $.post('/move/review/submit?mid=<?php echo $this->mid?>',{cid:gid},function(e){
            alert(e.msg);
            location.reload();
        },'json')
    })
    ...
    $('.noac').click(function(){
        //$('.over').show();
        cid = $(this).next().val();
        $.post('/move/review/noaccess?mid=<?php echo $this->mid?>',{cid:cid},function(e){
            alert(e.msg);
            location.reload();
        },'json')
    })
    ...
    $('.sub').click(function(){
        ...
        $.post('/move/review/noaccess?mid=<?php echo $this->mid?>',{message:message,gid:gid},function(e){
            alert(e.msg);
            location.reload();
        },'json')
    })
    $('.all').click(function(){
        ...
        $.post('/move/review/allpost?mid=<?php echo $this->mid?>',{cid:ids},function(e){
            alert(e.msg);
            location.reload();
        },'json')
    })
