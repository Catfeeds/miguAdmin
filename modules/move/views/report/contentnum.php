...
<script>
    ...
    function getData(page) { //获取当前页数据
        ...
        $.ajax({
            type: 'GET',
            url: '/move/report/contentdata?mid='+"<?php echo $_GET['mid'];?>"+"&first="+first+"&end="+end+"&keyword="+keyword+"&province="+provinceid+"&city="+cityid,
            data: {'page': page - 1},
            dataType: 'json',
    ...
    function out(){
        ...
        window.location.href = '/move/report/out?mid=<?php echo $this->mid?>&first='+first+'&keyword='+keyword+'&end='+end+'&province='+provinceid+'&city='+city;
        return false;
