...
//	var_dump($sql_work);die;
            ...
            if(!empty($_REQUEST['allbtn'])){
                ...
                if($allbtn=='已通过'){
                     ...
                     $sql = "select a.add_time,b.*,c.username from yd_ver_review_record as a inner join yd_ver_screen_content_copy as b on a.bind_id=b.id and a.review_flag='1' and a.type=3 inner join yd_ver_admin as c on a.user_id=c.id ";
