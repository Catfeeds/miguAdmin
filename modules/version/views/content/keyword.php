...
<script>
	...
	if(!empty(title)){
	   var url = "&title=" + title
        ...
        window.location.href="/version/content/keyword?mid="+mid+url+ "&type="+type+'&adminLeftNavFlag=1&adminLeftOne='+adminLeftOne+'&adminLeftTwo='+adminLeftTwo+'&adminLeftOneName='+adminLeftOneName+'&adminLeftTwoName='+adminLeftTwoName;
    })
