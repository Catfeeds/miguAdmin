<form action="" method="post" enctype="multipart/form-data">
	<table class="mtable" width="50%" cellpadding="10" cellspacing="0">
		...
		<tr>
			<td align="right">usergroup:</td>
			<td><input type="text" name="usergroup" id="usergroup" class="form-input" value="0"></td>
		</tr>
		<tr>
			<td align="right">epgcode:</td>
			<td><input type="text" name="epgcode" id="epgcode" class="form-input" value="0"></td>
		</tr>
		<span class="s">
            <tr id="addr">
		...
		<tr id="cp">
			...
			<td>
				<select name="cp[]" id="p0" class="form-input" style="width: 140px">
					...
					<option value="20">一橙</option>
					<option value="21">公网</option>
				</select>
			</td>
		</tr>
