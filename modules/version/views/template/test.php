...
<div style="background:url(/file/template/template_add_bg.jpg) no-repeat;width:1920px;padding-left:<?php echo $h_coord/2;?>px;padding-top:<?php echo $v_coord/2;?>px;min-height:540px;background-size: 1920px 540px">
