<style type="text/css">
    ...
    .m-825-429{ width:280px;  height:250px;  border:1px solid #ccc;  border-radius: 8px;  float:left;  margin-bottom: 20px;}
    ...
    <tr class="utp" style="display:none">
        ...
        <td><select name="uType" class="form-input w300" id="uType">
        	<option  value="4">海报专题</option>
                ...
                <option  value="9">多集标题详情页</option>
                <option  value="10">横图单片详情页</option>
...
<script>
	...
	G.nid="<?php echo $_GET['nid'];?>";
        ...
        $.post('/version/site/firstpageadd?mid=<?php echo $this->mid?>&flag=1',G,function(d){
