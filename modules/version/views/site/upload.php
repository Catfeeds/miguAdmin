...
<option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='4'){echo "selected=selected"; }?> value="4">海报专题</option>
        	...
        	<option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='17'){echo "selected=selected"; }?> value="17">河南专题</option>
                ...
                <option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='8'){echo "selected=selected"; }?> value="8">多集数字详情页</option>
                <option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='9'){echo "selected=selected"; }?> value="9">多集标题详情页</option>
                <option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='10'){echo "selected=selected"; }?> value="10">横图单片详情页</option>
                ...
                <option <?php $uType = !empty($ui[$address][$fid]['uType'])?$ui[$address][$fid]['uType']:'';if($uType=='16'){echo "selected=selected"; }?> value="16">本地播放</option>
