...
.m-270-280{  width:270px;  height:280px;  border:1px solid #ccc;  border-radius: 8px;  float:left;  }
    ...
    .m-195-135{width:195px;  height:134px;  border:1px solid #ccc;  border-radius: 8px;  float:left; }
...
<table class="mtable" width="100%" cellspacing="0" cellpadding="10">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="up-main" id="main">
                <?php
                echo "<div class='m-".$info['width']."-".$info['height']."' style='position:relative'>
		...
		<?php else:?>
		 <span class="infoSpan">请上传宽为<?php echo $info['width'] ;?>，高为<?php echo $info['height'];?>的图片！</span>
		<?php endif;?>
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td align="center" colspan="2">
            ...
            <input type="button" value="取消" class="gray" onclick="window.history.go(-1)">
        </td>
    </tr>
</table>
<script>
    ...
    $('.save').click(function()
    {
        ...
        G.screenGuideId    = <?php echo $info['screenGuideId'] ;?>;
        G.epg    = "<?php echo $info['epg'] ;?>";
        G.width  = "<?php echo $info['width']?>";
        G.height  = "<?php echo $info['height']?>";
        G.x  = "<?php echo $info['x']?>";
        G.y  = "<?php echo $info['y']?>";
        G.order  = "<?php echo $info['order']?>";
//        console.log(G);return false;
        ...
        $.post('/version/screen/firstPageAdd?mid=<?php echo $this->mid?>&flag=1',G,function(d){
