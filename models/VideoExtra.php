...
class VideoExtra extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('subserial_ids', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, vid, cp, prize, boxoffice, subtitles, comment, orders, end, score, bftime, total, tvstation, subserial_ids', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('subserial_ids',$this->subserial_ids,true);
