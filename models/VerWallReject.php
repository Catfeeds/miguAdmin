...
/**
 * This is the model class for table "{{ver_wall_reject}}".
 *
 * The followings are the available columns in table '{{ver_wall_reject}}':
 * @property integer $id
 ...
 */
class VerWallReject extends CActiveRecord
{
	/**
	 ...
	 * @return VerWallReject the static model class
	 */
