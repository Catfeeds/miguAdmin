...
/**
 * This is the model class for table "{{ver_reject}}".
 *
 * The followings are the available columns in table '{{ver_reject}}':
 * @property integer $id
 ...
 */
class VerReject extends CActiveRecord
{
	/**
	 ...
	 * @return VerReject the static model class
	 */
