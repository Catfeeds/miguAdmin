...
/**
 * This is the model class for table "{{ver_message_reject}}".
 *
 * The followings are the available columns in table '{{ver_message_reject}}':
 * @property integer $id
 ...
 */
class VerMessageReject extends CActiveRecord
{
	/**
	 ...
	 * @return VerMessageReject the static model class
	 */
