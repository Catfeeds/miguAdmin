...
/**
 * This is the model class for table "{{ver_wall_log}}".
 *
 * The followings are the available columns in table '{{ver_wall_log}}':
 * @property integer $id
 ...
 */
class VerWallLog extends CActiveRecord
{
	/**
	 ...
	 * @return VerWallLog the static model class
	 */
