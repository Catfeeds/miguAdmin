...
/**
 * This is the model class for table "{{ver_screen_content_del}}".
 *
 * The followings are the available columns in table '{{ver_screen_content_del}}':
 * @property integer $id
 ...
 */
class VerScreenContentDel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, addTime, upTime, screenGuideid, width, height, delFlag, order, sid', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return VerScreenContentDel the static model class
	 */
