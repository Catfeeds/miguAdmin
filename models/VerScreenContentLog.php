...
/**
 * This is the model class for table "{{ver_screen_content_log}}".
 *
 * The followings are the available columns in table '{{ver_screen_content_log}}':
 * @property integer $id
...
class VerScreenContentLog extends CActiveRecord
{
	 ...
	 * @return VerScreenContentLog the static model class
	 */
