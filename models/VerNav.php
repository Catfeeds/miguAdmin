...
/**
 * This is the model class for table "{{ver_nav}}".
 *
 * The followings are the available columns in table '{{ver_nav}}':
 * @property string $id
 * @property string $gid
 ...
 */
class VerNav extends CActiveRecord
{
	/**
	 ...
	 * @return VerNav the static model class
	 */
