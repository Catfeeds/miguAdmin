...
class VerCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('orders, score, year, is_free', 'length', 'max'=>50),
			array('simple_set', 'length', 'max'=>70),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, CountryOfOrigin, actor, boxoffice, cp, director, end, keyword, language, orders, score, type, year, prize, gid, hdflag, short, simple_set, is_free', 'safe', 'on'=>'search'),
		);
	}
