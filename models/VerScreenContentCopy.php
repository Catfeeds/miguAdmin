...
class VerScreenContentCopy extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, type, tType, param, action, pic, cp, epg, addTime, upTime, screenGuideid, cid, width, height, x, y, delFlag, order, uType, user, flag, sid, videoUrl', 'safe', 'on'=>'search'),
		);
	}
