...
/**
 * This is the model class for table "{{ver_message_log}}".
 *
 * The followings are the available columns in table '{{ver_message_log}}':
 * @property integer $id
 ...
 */
class VerMessageLog extends CActiveRecord
{
	/**
	 ...
	 * @return VerMessageLog the static model class
	 */
